...
<head>
    ...
    <link rel="stylesheet" href="../Estaciositev2/css/styles.css">
...
<body>
    ...
    <div id="background">
        <video autoplay loop muted>
            <source src="../Estaciositev2/img/Gliding Toad.mp4">
        </video>
    </div>
    <div id="app">
        <header>
            <img src="../Estaciositev2/img/sapo.png" alt="">
            <ul class="navigation">
            
                
                <li><a href="../Estaciositev2/funcoes.php">Funções</a></li> 
                
                <li><a href="../Estaciositev2/planos.php">Planos</a></li>
                
                <li><a href="../Estaciositev2/registro.php">Registrar</a></li>
                
                <li><a href="../Estaciositev2/painel.php">Entrar</a></li>
    ...
    <main>
      <div id="centro">
          ...
          <img src="../Estaciositev2/img/download__49_-removebg-preview-transformed-removebg-preview.png" alt="">
          <p>Aumente sua produtividade e simplifique sua rotina com nosso site de gerenciamento de tarefas. Organize suas atividades diárias, estabeleça metas, defina prazos e acompanhe seu progresso em um ambiente fácil de usar e intuitivo. Ideal para profissionais, estudantes e equipes, nossa plataforma oferece recursos poderosos como categorização de tarefas, notificações automáticas, e integração com outras ferramentas. Simplifique seu dia a dia, mantenha-se focado e atinja seus objetivos com eficiência.</p>
          <div>
            <a id="registrar" href="../Estaciositev2/registro.php">Registre-se agora</a>
            <button id="botaologin"><a href="../Estaciositev2/login.php">Login</a></button>
          </div>
